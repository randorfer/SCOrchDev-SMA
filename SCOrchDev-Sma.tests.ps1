...
$manifestPath = "$here\SCOrchDev-Sma.psd1"
Import-Module SCOrchDev-Sma -Force

Describe -Tags 'VersionChecks' 'SCOrchDev-Sma manifest' {
    ...
    It 'has a valid name in the manifest' {
        $script:manifest.Name | Should Be SCOrchDev-Sma
    }

    It 'has a valid guid in the manifest' {
        $script:manifest.Guid | Should Be '41dfeede-32f0-42e5-b4b0-43eac3336fcd'
    }
...
Describe 'Style rules' {
    $SCOrchDevUtilityRoot = (Get-Module SCOrchDev-Sma).ModuleBase
